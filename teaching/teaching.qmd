...
|8| 20 Marzo 2026 | I/O Multiplexing con epoll() | [Slides](../documents/resid26_epoll.pdf), [<span style="color:#cc0000">HO6</span>](../documents/resid26_ho6.pdf), ```c {{< include ../src/server_epoll.c >}} ```, [test_multifd.sh](../src/test_multifd.sh)| Piccardi Ch.10 |
