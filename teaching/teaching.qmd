...
Il corso ha una **durata di 30 ore** e vale **3 CFU** .
Si propone di fornire agli studenti gli **strumenti matematici** necessari per la **modellazione cinematica e dinamica** delle tipologie di robot più comuni, come i **manipolatori robotici seriali**, i **car-like-robot** e i **multi-rotori**.
Inoltre, mira a far comprendere gli **algoritmi di funzionamento dei moderni visori per la realtà virtuale**, inclusi **Visual-Inertial Odometry** e **SLAM**.
...
Sono richiesti **elementi di Algebra Lineare** ed **elementi di programmazione in linguaggio Python**.

## 4 Modalità di erogazione

Il corso prevede **lezioni frontali** ed **esercitazioni simulative al computer**.
