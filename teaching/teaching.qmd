...
| 27 Febbraio 2025 | Socket Programming in Linux      | [Slides](../documents/labresid_3.pdf), [CS6](../documents/cs_socket.pdf), [HO1](../documents/ho1.pdf), [server_tcp.c](../src/server_tcp.c), [client_tcp.c](../src/client_tcp.c) | Piccardi Ch.6,13,14 |
...
### Modalità d'esame
Report delle esercitazioni + Progetto Finale + Presentazione Orale (<span style="color:#9b111e">con verifica dei concetti e delle abilità acquisite durante le attività di laboratorio</span>)
